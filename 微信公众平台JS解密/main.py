...
key=jsCode.call("exports","20150611DW")
print(key)

s=requests.Session()

data={
    'username':"1766423284@qq.com",
    'pwd':key,
    'imgcode':'',
    'f':'json',
    'userlang':'zh_CN',
...
headers={
    ...
    'Cookie':'ua_id=T7qvXJcdCm5XSOniAAAAAH01pOTbaQU3J1C8g_MmZZg=; pgv_pvi=4643640320; pgv_si=s2272056320',
...
redDict=res.json()
url=redDict['redirect_url']
res2=s.get("https://mp.weixin.qq.com"+url)
print(res2.text)
