var r = function(e) {
    var t = md5("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.9 Safari/537.36")
      , r = "" + (new Date).getTime()
      , i = r + parseInt(10 * Math.random(), 10);
    return md5("fanyideskweb" + e + i + "Nw(nmmbP%A-r6U3EUn]Aj")
}
md5 = function (e) {
